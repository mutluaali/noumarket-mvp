...
export const metadata = {
  ...
  description: 'Ödeme işlemi tamamlanmadı. İlanınız normal şekilde yayında kalmaya devam eder.',
    ...
    <main className="min-h-screen bg-slate-100 flex items-center justify-center p-6">
      <section className="w-full max-w-md rounded-3xl bg-white p-8 shadow-xl text-center">
        ...
        <p className="text-slate-600 mb-6">
          Öne çıkarma paketi satın alımı tamamlanmadı. İlanın normal şekilde yayında kalmaya devam eder.
        </p>
