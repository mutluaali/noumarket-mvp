...
export default function ListingDetailModal({
  ...
  return (
    <div className="fixed inset-0 z-50 bg-slate-950/60 p-0 backdrop-blur-sm md:p-4">
      <div className="mx-auto grid max-h-screen max-w-7xl overflow-hidden bg-white shadow-2xl md:max-h-[94vh] md:rounded-[2rem] lg:grid-cols-[minmax(0,1fr)_390px]">
        <div className="overflow-auto bg-slate-50">
          <div className="sticky top-0 z-20 flex items-center justify-between border-b border-slate-200 bg-white/95 px-5 py-4 backdrop-blur">
            <div>
              ...
              <h2 className="line-clamp-1 text-xl font-black text-slate-950">{selected.title}</h2>
            </div>
          ...
          <div className="p-4 md:p-5">
            <div className="relative overflow-hidden rounded-[1.75rem] bg-slate-900 shadow-sm ring-1 ring-slate-200">
              <img src={currentImage} alt={selected.title} className="h-[300px] w-full object-cover md:h-[520px]" />
            ...
            <section className="mt-5 rounded-[1.75rem] bg-white p-5 shadow-sm ring-1 ring-slate-200">
              <div className="flex flex-col gap-4 md:flex-row md:items-start md:justify-between">
                <div>
                  <div className="text-sm font-bold text-slate-500">{selected.category || 'İlan'}</div>
                  <h1 className="mt-1 text-3xl font-black tracking-tight text-slate-950">{selected.title}</h1>
                ...
                <div className="text-left md:text-right">
                  <div className="text-4xl font-black text-blue-600">{selected.priceText || 'Görüşülür'}</div>
        ...
        <aside className="overflow-auto border-l border-slate-200 bg-white p-5">
          <section className="rounded-[1.75rem] bg-slate-50 p-5 ring-1 ring-slate-200">
          ...
          <section className="mt-5 rounded-[1.75rem] bg-emerald-50 p-5 text-sm font-semibold leading-7 text-emerald-900 ring-1 ring-emerald-200">
          ...
          <section className="mt-5 rounded-[1.75rem] bg-white p-5 ring-1 ring-slate-200">
