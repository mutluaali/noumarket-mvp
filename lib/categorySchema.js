export const CATEGORY_TREE = [
  {
    ...
    children: [
      { id: 'housing', label: 'Konut', count: 683000, children: [
        { id: 'housing-sale', label: 'Satılık', count: 274577, children: [
          { id: 'sale-apartment', label: 'Daire', count: 151000, fields: ['rooms','areaM2','floor','heating','furnished'] },
          { id: 'sale-detached-house', label: 'Müstakil Ev', count: 72000, fields: ['rooms','areaM2','floor','heating','furnished'] },
          { id: 'sale-farm-house', label: 'Çiftlik Evi', count: 18500, fields: ['rooms','areaM2','heating','furnished'] },
          { id: 'sale-villa', label: 'Villa', count: 33077, fields: ['rooms','areaM2','pool','furnished'] },
        ]},
        { id: 'housing-rent', label: 'Kiralık', count: 210654, children: [
          { id: 'rent-apartment', label: 'Daire', count: 120000, fields: ['rooms','areaM2','floor','deposit','heating','furnished'] },
          { id: 'rent-detached-house', label: 'Müstakil Ev', count: 42000, fields: ['rooms','areaM2','deposit','heating','furnished'] },
          { id: 'rent-farm-house', label: 'Çiftlik Evi', count: 6300, fields: ['rooms','areaM2','deposit','heating','furnished'] },
          { id: 'rent-villa', label: 'Villa', count: 42354, fields: ['rooms','areaM2','deposit','pool','furnished'] },
        ]},
      ]},
      { id: 'workplace-real-estate', label: 'İşyeri', count: 124901, children: [
        { id: 'workplace-sale', label: 'Satılık', count: 43000, fields: ['areaM2','floor','usageType','furnished'] },
        { id: 'workplace-rent', label: 'Kiralık', count: 81901, fields: ['areaM2','floor','deposit','usageType','furnished'] },
      ]},
      { id: 'land', label: 'Arsa', count: 229999, children: [
        { id: 'residential-land', label: 'Konut İmarlı', count: 92000, fields: ['areaM2','zoningStatus','roadAccess'] },
        { id: 'commercial-land', label: 'Ticari İmarlı', count: 31000, fields: ['areaM2','zoningStatus','roadAccess'] },
        { id: 'agricultural-land', label: 'Tarla / Bahçe', count: 106999, fields: ['areaM2','zoningStatus','roadAccess'] },
      ]},
    ],
  },
  {
