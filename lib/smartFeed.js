export function scoreListingForFeed(listing, context = {}) {
  ...
  const sellerBoost = listing?.premiumSeller ? 22 : 0;
  ...
  return Math.round(freshness + premiumBoost + sellerBoost + viewScore + categoryAffinity + locationAffinity + queryMatch);
}
